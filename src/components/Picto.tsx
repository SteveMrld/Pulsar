...
const PICTO_MAP: Record<string, string> = {
  ...
  cockpit:    '/assets/organs/eeg.png',
  bilan:      '/assets/organs/virus.png',
  urgence:    '/assets/organs/heart.png',
  pharma:     '/assets/organs/blood.png',
  treatment:  '/assets/organs/blood.png',
  // Logo
