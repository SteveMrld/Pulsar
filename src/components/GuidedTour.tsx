...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    narrative: 'Vous êtes sur le dashboard chef de service — vue d\'ensemble en temps réel : patients actifs, alertes critiques, scores VPS, répartition par phase.',
    narrativeEn: "You're on the service dashboard — real-time overview: active patients, critical alerts, VPS scores, phase distribution.",
    highlight: 'Depuis ici, accédez à la file active ou admettez un nouveau patient.',
    highlightEn: 'From here, access the active caseload or admit a new patient.',
    duration: 0,
    cta: 'Ouvrir le dossier Inès →',
