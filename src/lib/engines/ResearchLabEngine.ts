...
export function generateProtocolSuggestions(ps: PatientState): ProtocolSuggestion[] {
  return [
    ...
    { title: "Anakinra en L2 pour FIRES suspecte", currentProtocol: "L1→L2→L3→L4(anakinra)", suggestedChange: "Score FIRES >= 7 + fievre + crises refractaires → anakinra des L2 en parallele du regime cetogene", rationale: "NLRP3/IL-1b = mecanisme etiologique (Lin 2021). Fenetre critique : initiation précoce J+7 max (Lai 2020 cohorte 25 patients). Shrestha 2023 : timing tardif = pas de recuperation cognitive.", evidence: ["Costagliola 2022", "Shrestha 2023", "Kenney-Jung 2016", "Lai 2020", "Wickström 2022"], estimatedImpact: "Anakinra H+24 vs H+96 : amelioration pronostique 30-50%", connectedEngines: ["TDE", "DDD", "Oracle", "Lab"] },
