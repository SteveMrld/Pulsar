...
export const PATIENT_ZERO_LEARNINGS = [
  ...
  'Early anakinra initiation if FIRES suspected — J+7 max (Lai 2020 / Wickström 2022)',
...
export const PATIENT_ZERO_CORRECTED_LEARNINGS = [
  ...
  { id: 'L005', learning: 'Anakinra administré J+10 (12 avril). 3 jours après signal optimal J+7 (Lai 2020). 4 jours de "préparation logistique" entre décision et admin.', confidence: 1.0, source: 'IMG_7867 + IMG_7869: "12 avril J+10 — Introduction Anakinra"' },
