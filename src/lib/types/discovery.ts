...
export const PARAMETER_META: Record<string, { label: string; category: string; unit?: string; color: string }> = {
  ...
  crp: { label: 'CRP', category: 'Bio', unit: 'mg/L', color: '#A78BFA' },
  pct: { label: 'PCT', category: 'Bio', unit: 'ng/mL', color: '#A78BFA' },
  ferritin: { label: 'Ferritine', category: 'Bio', unit: 'ng/mL', color: '#A78BFA' },
  wbc: { label: 'Leucocytes', category: 'Bio', unit: 'G/L', color: '#A78BFA' },
  platelets: { label: 'Plaquettes', category: 'Bio', unit: 'G/L', color: '#A78BFA' },
  lactate: { label: 'Lactate', category: 'Bio', unit: 'mmol/L', color: '#A78BFA' },
  ...
  ewe_score: { label: 'EWE', category: 'Moteurs', unit: '/100', color: '#A78BFA' },
