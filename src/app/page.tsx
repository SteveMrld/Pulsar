    ...
    <div className="page-enter" style={{ minHeight: '100vh', background: 'var(--p-bg)', position: 'relative' }}>
      ...
      <section className="page-enter" style={{ textAlign: 'center', padding: 'var(--p-space-24) var(--p-space-8) var(--p-space-16)', maxWidth: '800px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', gap: 'var(--p-space-4)', justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href="/signup" style={{ padding: 'var(--p-space-3) var(--p-space-8)', borderRadius: 'var(--p-radius-lg)', background: 'var(--p-vps)', color: '#fff', textDecoration: 'none', fontWeight: 700, fontSize: 'var(--p-text-base)', boxShadow: 'var(--p-shadow-glow-vps)', transition: 'transform 0.2s, box-shadow 0.2s' }}>
            Accéder à PULSAR
          </Link>
          <a href="#features" style={{ padding: 'var(--p-space-3) var(--p-space-8)', borderRadius: 'var(--p-radius-lg)', background: 'var(--p-bg-elevated)', border: 'var(--p-border)', color: 'var(--p-text)', textDecoration: 'none', fontWeight: 500, fontSize: 'var(--p-text-base)' }}>
            Découvrir
          </a>
        </div>
