    ...
    <div className="page-enter" style={{ minHeight: '100vh', background: 'var(--p-bg)', position: 'relative' }}>
      ...
      <nav className="glass" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--p-space-3)' }}>
          <img src="/assets/logo-pulsar.png" alt="PULSAR" width={36} height={36} style={{ borderRadius: 8, filter: 'drop-shadow(0 0 8px rgba(108,124,255,0.3))', display: 'block', objectFit: 'cover' }} />
